        ...
        !loading ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bounce-press ripple min-h-12 flex-1 rounded-full glass-btn-primary text-sm font-semibold text-primary-foreground"
            >
              Continue to Payment
            </button>
          </div>
        ...
        <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex shrink-0 items-center gap-2">
                <button
                  ...
                  className="bounce-press ripple grid size-9 place-items-center rounded-full glass-btn text-foreground"
                >
          ...
          <section className="flex flex-col gap-2.5 rounded-3xl border border-border bg-card p-4">
            ...
            <button
              ...
              className="bounce-press ripple mt-1 min-h-10 rounded-full glass-btn text-xs font-semibold text-foreground"
            >
